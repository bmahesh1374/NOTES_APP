...
import NotesCard from "../../components/notes-card/NotesCard.jsx"
            ...
            <main className="flex gap-3">
                ...
                <div className="flex flex-col w-screen mt-7">
                    <div className="flex flex-col w-[450px] border-red-400 relative self-center">
                        <input value={title} onChange={onTitleChange} className="border border-neutral-800 rounded-t-md focus:outline-none border-b-0-1" placeholder="Enter Title" />
                    ...
                    <div className="mt-14 ml-10 flex-col gap-5">
                        {
                                    ...
                                    <div className="flex flex-wrap gap-6">
                                        {
                                            pinnedNotes?.length > 0 && pinnedNotes.map(({id,title,text,isPinned}) => (
                                                <NotesCard key = {id} id = {id} title={title} isPinned={isPinned} />
                                            ))
                                        }
                                    </div>
                                </div>
